        ...
        <div className="bg-gradient-to-br from-zinc-900 to-black text-white py-20">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-purple-300 max-w-2xl mx-auto">
              Cuéntanos sobre tu auto y te enviaremos un presupuesto rápido y claro.
            </p>
          </div>
        </div>
      )}
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-xl p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              <div>
                ...
                <input type="text" name="motor" value={formData.motor} onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-purple-500" placeholder="Ej: 2.0L" />
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <select name="servicio" value={formData.servicio} onChange={handleChange} required
                ...
                <option value="Motor">Problemas de Motor</option>
                <option value="Diagnóstico">Diagnóstico General</option>
                <option value="Modificaciones">Modificaciones / Custom</option>
            ...
            <div className="mb-12">
              ...
              <textarea name="descripcion" value={formData.descripcion} onChange={handleChange} rows={5}
                ...
                placeholder="Describe con detalle el problema..." required />
            </div>
