...
export default function Agendar() {
  ...
  const servicios = [
    { nombre: "Cambio de Aceite y Filtros", duracion: "1 hora" },
    { nombre: "Afinación Mayor", duracion: "2.5 horas" },
    { nombre: "Revisión y Reparación de Frenos", duracion: "1.5 horas" },
    { nombre: "Diagnóstico Computarizado", duracion: "45 minutos" },
    { nombre: "Alineación y Balanceo", duracion: "1 hora" },
    { nombre: "Suspensión / Amortiguadores", duracion: "2 horas" },
    { nombre: "Modificaciones Estéticas", duracion: "Variable" },
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-xl p-10">
            ...
            <div className="mb-12">
              ...
              <textarea name="notas" value={formData.notas} onChange={handleChange} rows={4}
                ...
                placeholder="Ej: El auto hace ruido al frenar..." />
            </div>
